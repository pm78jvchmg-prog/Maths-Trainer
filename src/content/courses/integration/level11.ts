  ...
  lessons: [
    {
      ...
      slides: [
        ...
        teach(
          ...
          prose(
            'The angles to know: $\\arcsin\\frac{1}{2} = \\frac{\\pi}{6}$, $\\arcsin\\frac{1}{\\sqrt{2}} = \\frac{\\pi}{4}$ and $\\arcsin\\frac{\\sqrt{3}}{2} = \\frac{\\pi}{3}$. Arcsine is odd, so $\\arcsin\\left(-\\frac{1}{2}\\right) = -\\frac{\\pi}{6}$.',
          ),
        ),
    ...
    },
    {
      ...
      slides: [
        ...
        teach(
          ...
          prose(
            'Standard values: $\\arctan 1 = \\frac{\\pi}{4}$, $\\arctan\\sqrt{3} = \\frac{\\pi}{3}$ and $\\arctan\\frac{1}{\\sqrt{3}} = \\frac{\\pi}{6}$. Arctangent is odd, so $\\arctan(-1) = -\\frac{\\pi}{4}$.',
          ),
        ),
    ...
    },
    {
      ...
      slides: [
        teach(
          ...
          prose('Half of $6$ is $3$, and $3^{2} = 9$, so $13 - 9 = 4$ is left over.'),
        ),
    ...
    },
    {
      ...
      slides: [
        ...
        teach(
          ...
          prose('So $\\int \\cosh x \\, dx = \\sinh x + C$ and $\\int \\sinh x \\, dx = \\cosh x + C$. With $kx$ inside, divide by $k$:'),
    ...
    },
    {
      ...
      slides: [
        ...
        teach(
          ...
          prose('So $\\operatorname{arsinh}\\frac{3}{4} = \\ln\\left(\\frac{3}{4} + \\frac{5}{4}\\right) = \\ln 2$.'),
        ),
