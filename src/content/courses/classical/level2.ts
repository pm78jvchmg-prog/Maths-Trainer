  ...
  lessons: [
    {
      ...
      slides: [
        teach(
          ...
          stacked('t^{2} = 20 \\div 4.9 = 4.0816\\ldots', 't = \\sqrt{4.0816\\ldots} = 2.0203\\ldots', 't = 2.02\\text{ s}', 'R = 6 \\times 2.0203\\ldots = 12.121\\ldots', 'R = 12.1\\text{ m}'),
          prose('Carry the unrounded time into $R$, and round only the value asked for. To the nearest half metre, $12.121\\ldots$ is $12\\text{ m}$: it is nearer $12$ than $12.5$.'),
        ...
        teach(
          prose('As it falls it gains downward speed $v_{y} = gt$, while its sideways speed never changes. From the same $20\\text{ m}$, it lands with $v_{y} = 9.8 \\times 2.0203\\ldots = 19.798\\ldots$, which is $19.8\\text{ m s}^{-1}$ to 1 decimal place.'),
          prose('Backwards, for the launch speed: to land $12\\text{ m}$ out after $2.0203\\ldots\\text{ s}$ in the air needs $u = 12 \\div 2.0203\\ldots = 5.939\\ldots$, which is $6\\text{ m s}^{-1}$ to the nearest half.'),
        ),
        ask('clm-horiz-tree'),
        ...
        teach(
          ...
          stacked('t = \\sqrt{5 \\div 4.9} = 1.0101\\ldots', 'R = 6 \\times 1.0101\\ldots = 6.060\\ldots', 'R = 6.1\\text{ m}'),
    ...
    },
    {
      ...
      slides: [
        ...
        teach(
          ...
          stacked('t_{\\text{top}} = 15 \\div 9.8 = 1.5306\\ldots = 1.53', 'T = 2 \\times 1.5306\\ldots = 3.0612\\ldots = 3.06', 'H = \\frac{15^{2}}{19.6} = 11.479\\ldots = 11.5', 'R = 10 \\times 3.0612\\ldots = 30.612\\ldots = 30.6'),
          prose('Each line carries the unrounded value from the one before; only the value written down is rounded.'),
        ),
        ask('clm-range-flow'),
        ask('clm-flight-tree'),
        ask('clm-max-height'),
        teach(
          ...
          stacked('u_{x} = 25 \\times 0.6 = 15', 'u_{y} = 25 \\times 0.8 = 20', 'T = \\frac{2 \\times 20}{9.8} = 4.0816\\ldots = 4.08', 'H = \\frac{20^{2}}{19.6} = 20.408\\ldots = 20.4', 'R = 15 \\times 4.0816\\ldots = 61.224\\ldots = 61.2'),
        ),
    ...
    },
    {
      ...
      slides: [
        ...
        teach(
          ...
          prose('At $7\\text{ rev s}^{-1}$ slowing at $0.8\\text{ rev s}^{-2}$ it is $\\theta = 49 \\div 1.6 = 30.625$, which is $30.5$ turns to the nearest half turn: $30.625$ is nearer $30.5$ than $31$.'),
        ),
    ...
    },
    {
      ...
      slides: [
        ...
        teach(
          ...
          stacked('a = \\frac{15^{2}}{11} = 20.4545\\ldots = 20.5', '20.4545\\ldots \\div 9.8 = 2.0871\\ldots = 2.1'),
          prose('So about $2.1g$.'),
        ),
