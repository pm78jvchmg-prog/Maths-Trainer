  ...
  lessons: [
    {
      ...
      slides: [
        ...
        ask('cm-gap-slider'),
        ask('cm-gap-slider', 2),
        ask('cm-speed-table', 2),
      ],
      skillCheck: [ask('cm-kmh-convert', 2), ask('cm-lap-time', 2), ask('cm-gap-slider', 2)],
    },
    {
      id: 'cm-l1-average',
      ...
      skillCheck: [ask('cm-stint-tree', 2), ask('cm-equal-halves', 2), ask('cm-avg-flow', 2)],
    },
    {
      id: 'cm-l1-relative',
      ...
      slides: [
        ...
        ask('cm-overtake-tree'),
        ask('cm-overtake-tree', 2),
        ask('cm-meet-slider', 2),
      ],
      skillCheck: [ask('cm-rel-velocity', 2), ask('cm-meet-time', 2), ask('cm-overtake-tree', 2)],
    },
    {
      id: 'cm-l1-stopping',
      ...
      slides: [
        ...
        ask('cm-stopping-tree'),
        ask('cm-stop-flow'),
        ask('cm-stopping-tree', 2),
      ],
      skillCheck: [ask('cm-thinking', 2), ask('cm-braking', 2), ask('cm-stop-flow', 2)],
    },
    {
      id: 'cm-l1-steps',
      ...
      slides: [
        ...
        ask('cm-traffic-table'),
        ask('cm-traffic-table', 2),
        teach(
          prose(
        ...
        ask('cm-step-error-tree'),
        ask('cm-step-velocity+choice', 2),
        ask('cm-step-error-tree', 2),
      ],
      skillCheck: [ask('cm-step-table', 2), ask('cm-traffic-table', 2), ask('cm-step-error-tree', 2)],
    },
  ],
  levelCheck: [
    ask('cm-kmh-convert', 2),
    ask('cm-lap-time', 2),
    ask('cm-gap-slider', 2),
    ask('cm-stint-tree', 2),
    ask('cm-equal-halves', 2),
    ask('cm-avg-flow', 2),
    ask('cm-meet-time', 2),
    ask('cm-overtake-tree', 2),
    ask('cm-braking', 2),
