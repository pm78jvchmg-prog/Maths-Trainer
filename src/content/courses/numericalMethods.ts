        ...
        },
        {
          ...
          slides: [
            ...
            teach(
              ...
              working("g'(x) &= x^{2}, \\quad g'(2.28) \\approx 5.2", "g'(x) &= \\frac{-10x}{(x^{2} - 3)^{2}}, \\quad g'(2.28) \\approx -4.7"),
      ...
      lessons: [
        {
          ...
          slides: [
            ...
            teach(
              ...
              prose('Carrying on from $2.1$, the root being $2.094551\\ldots$:'),
              working('x_1 &= 2.1 & &\\text{out by } 0.005', 'x_2 &= 2.094568 & &\\text{out by } 0.00002', 'x_3 &= 2.094551 & &\\text{out by } 0.0000000002'),
            ),
        ...
        },
        {
          ...
          slides: [
            ...
            teach(
              ...
              working('h = 0.5: \\quad \\text{error} &= 4 - 4.75 = -0.75', 'h = 0.25: \\quad \\text{error} &\\approx \\tfrac{1}{2}(-0.75) = -0.375', 'y_6 &\\approx 4.75 - 0.375 = 4.375'),
            ),
