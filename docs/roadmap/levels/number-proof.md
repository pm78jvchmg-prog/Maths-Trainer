...
Needs: Euclid's Algorithm (the HCF by repeated division, working it backwards to
write the HCF as ax + by, and whole-number solutions of ax + by = c);
Modular Arithmetic (congruence mod n, adding, multiplying and powers mod n,
