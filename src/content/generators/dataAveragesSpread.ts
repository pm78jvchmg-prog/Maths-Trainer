 ...
 * standard deviation, with two sets compared by mean and spread. Level 4 is
 * cumulative frequency: running totals down a grouped table, the curve
 * through the upper boundaries (drawn by `cumulativeSvg`), readings off it,
 * the median and quartiles at n/4, n/2 and 3n/4, percentiles at pn/100, and
 * the same readings by interpolating inside a class.
 *
