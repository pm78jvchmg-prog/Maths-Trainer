...
export const WIDGET_KIND_CEILING = 27;
 ...
 * progress is measured. Logarithms left both lists in batch A5, Integration in
 * A9, and Exponents & Radicals in A3.
 */
...
/** The list above may only shrink. Edit this downwards, never upwards. */
export const GENERATOR_REPETITION_CEILING = 78;
