# Series Expansions: level plan

Written by C14.

Has: Maclaurin Series (coefficients as f^(n)(0)/n! and when a series exists,
the exponential series with e^(kx), sine and cosine with their sign pattern,
ln(1 + x) and 1/(1 - x) with the ranges they hold for, new series by
...
coefficients; after C13 Differential Equations has landed).
