  ...
  lessons: [
    {
      ...
      slides: [
        teach(
          ...
          display('5 + 7 + 9 = 21'),
          prose('The perimeter is $21$ cm. A rectangle has two lengths and two widths, so an $8$ cm by $3$ cm rectangle has'),
          display('8 + 3 + 8 + 3 = 22'),
        ...
        teach(
          ...
          prose('With a perimeter of $30$ cm:'),
          display('9 + x = 30 \\div 2 = 15'),
          display('x = 15 - 9 = 6'),
          prose('An isosceles triangle with a perimeter of $32$ cm and a base of $10$ cm: the two equal sides share what is left.'),
          display('2x = 32 - 10 = 22'),
    ...
    },
    {
      ...
      slides: [
        teach(
          ...
          prose('Backwards, the radius is half the diameter. A diameter of $9$ cm:'),
        ...
        teach(
          ...
          prose('Leave the answer **in terms of** $\\pi$, using the $\\pi$ key. A radius of $5$ cm:'),
          display('C = 2 \\times \\pi \\times 5 = 10\\pi'),
          prose('Backwards: a circumference of $18\\pi$ cm means the diameter is $18$ cm, so the radius is $9$ cm.'),
        ),
        ...
        teach(
          ...
          display('P = 6\\pi + 12'),
          prose('A **quarter circle** has a quarter of the circumference and two radii. With a radius of $4$ cm:'),
    ...
    },
    {
      ...
      slides: [
        ...
        teach(
          ...
          prose('With $\\theta = 60^\\circ$ and $r = 6$ cm, the whole circumference is $12\\pi$:'),
          display('x = \\frac{60}{360} \\times 12\\pi = \\frac{1}{6} \\times 12\\pi = 2\\pi'),
        ),
        ask('geo-arc-length'),
        ask('geo-arc-length+choice', 2),
        teach(
          prose('Backwards: an arc of $4\\pi$ cm with a radius of $12$ cm. The whole circumference is $24\\pi$, so the arc is'),
