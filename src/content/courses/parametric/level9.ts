  ...
  lessons: [
    {
      ...
      slides: [
        ...
        teach(
          prose('How far it has moved across is the change in $x$. On $x = 4 + 3t$, at $t = 0$ it has $x = 4$ and at $t = 5$ it has $x = 19$, so in the first $5$ seconds it moves'),
          display('19 - 4 = 15'),
        ...
        teach(
          ...
          prose('The $5$ is half of the $10$. For $x = 4t$, $y = 20t - 5t^{2}$ at $t = 3$, work out each part of $y$, then take one from the other:'),
          ...
          prose('Square the $3$ first, then multiply by $5$. And $x = 4 \\times 3 = 12$, so after $3$ seconds it is $12$ metres across and $15$ metres up.'),
        ),
    ...
    },
    {
      ...
      slides: [
        teach(
          ...
          prose('A drone is at $x = 4 + 3t$, $y = 10 + 2t$. When is it $30$ metres up?'),
          display('10 + 2t = 30'),
          display('2t = 20, \\quad t = 10'),
          prose('Then $x = 4 + 3 \\times 10 = 34$, so it is at $(34, 30)$.'),
          prose('A boat at $x = 2 + 5t$, $y = 8 - t$ reaches $x = 17$ when $2 + 5t = 17$: then $5t = 15$, so $t = 3$ and $y = 8 - 3 = 5$.'),
        ),
        ask('pmod-reach-time'),
        ask('pmod-reach-tree'),
        ask('pmod-reach-time+choice', 2),
        teach(
          prose('A ball thrown from the ground lands when its height is $0$ again. For $x = 4t$, $y = 20t - 5t^{2}$:'),
          display('20t - 5t^{2} = 0'),
          display('5t(4 - t) = 0'),
          ...
          prose(
            '$t = 0$ is the moment it is thrown, so it lands at $t = 4$. Then $x = 4 \\times 4 = 16$: it lands $16$ metres away.',
          ),
        ),
        ask('pmod-land-time'),
        ...
        teach(
          prose('A rate can be negative: a drone at $y = 40 - 3t$ is coming down. It is $19$ metres up when'),
          display('40 - 3t = 19'),
          display('3t = 21, \\quad t = 7'),
    ...
    },
    {
      ...
      slides: [
        teach(
          prose(
            'At the top of its flight the ball stops rising for a moment: the tangent to its path is horizontal, so $\\frac{dy}{dt} = 0$, as in Parametric Curves. For $x = 4t$, $y = 20t - 5t^{2}$:',
          ),
          display('\\frac{dy}{dt} = 20 - 10t'),
          display('20 - 10t = 0, \\quad t = 2'),
          ...
          prose('In general $\\frac{dy}{dt} = v - 10t$, so the top is at $t = \\frac{v}{10}$: halfway to landing.'),
        ),
        ask('pmod-top-time'),
        ask('pmod-top-slider'),
        ask('pmod-top'),
        teach(
          ...
          prose('For $x = 3t$, $y = 30t - 5t^{2}$:'),
          display('30 - 10t = 0, \\quad t = 3'),
        ...
        teach(
          ...
          display('y = h + vt - 5t^{2}'),
          prose(
            'The $h$ does not change $\\frac{dy}{dt}$, so the top comes at the same time; the height gains $h$. For $y = 15 + 20t - 5t^{2}$, the top is at $t = 2$, and',
          ),
    ...
    },
    {
      ...
      slides: [
        teach(
          ...
          display('1 + 3t = 9 + t'),
          display('2t = 8, \\quad t = 4'),
          prose('At $t = 4$, A has $y = 2 + 4 = 6$ and B has $y = 14 - 2 \\times 4 = 6$. Both are at $(13, 6)$ at the same moment: they collide.'),
        ),
        ask('pmod-meet-time'),
        ask('pmod-meet-tree'),
    ...
    },
    {
      ...
      slides: [
        teach(
          prose(
            'The path itself has an equation in $x$ and $y$ only. As in Parametric Curves, make $t$ the subject of the $x$ equation, then put it into the $y$ equation. For a boat at $x = 3 + 2t$, $y = 1 + 6t$:',
          ),
          display('t = \\frac{x - 3}{2}'),
          display('y = 1 + 6 \\times \\frac{x - 3}{2}'),
          display('y = 1 + 3(x - 3)'),
          display('y = 3x - 8'),
          prose('Check with the start, $(3, 1)$: $3 \\times 3 - 8 = 1$. Steady motion always gives a straight line.'),
        ),
        ask('pmod-line-path'),
        ask('pmod-path-flow'),
        ask('pmod-line-path+choice', 2),
        teach(
          prose('For a thrown ball, $x = ut$ gives $t = \\frac{x}{u}$. For $x = 5t$, $y = 20t - 5t^{2}$:'),
          display('t = \\frac{x}{5}'),
        ...
        teach(
          prose(
            'The model only holds while the ball is in the air: from the throw at $t = 0$ until it lands. For $x = 5t$, $y = 20t - 5t^{2}$ it lands when $5t(4 - t) = 0$, at $t = 4$, so',
          ),
          display('0 \\le t \\le 4'),
          prose('Across, that is $x$ from $0$ to $5 \\times 4 = 20$:'),
