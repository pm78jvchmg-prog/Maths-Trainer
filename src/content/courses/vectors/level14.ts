  ...
  lessons: [
    {
      ...
      slides: [
        ...
        teach(
          ...
          prose('With $\\mathbf{a} = 3\\mathbf{i} - 2\\mathbf{j}$ and $\\mathbf{b} = -\\mathbf{i} + 5\\mathbf{j}$:'),
          stacked(
    ...
    },
    {
      ...
      slides: [
        ...
        teach(
          ...
          prose('With $\\mathbf{a} = 2\\mathbf{i} + \\mathbf{j}$ and $\\mathbf{b} = 5\\mathbf{i} - 3\\mathbf{j}$:'),
    ...
    },
    {
      ...
      slides: [
        teach(
          ...
          stacked('\\tan\\theta = \\frac{4}{3}', '\\theta = \\tan^{-1}(\\tfrac{4}{3}) = 53.1^\\circ', '\\theta \\approx 53^\\circ'),
    ...
    },
    {
      ...
      slides: [
        teach(
          ...
          prose('Adding and scaling work exactly as before, one component at a time. With $\\mathbf{a} = 2\\mathbf{i} - \\mathbf{j} + 4\\mathbf{k}$ and $\\mathbf{b} = \\mathbf{i} + 3\\mathbf{j} - 5\\mathbf{k}$, for $2\\mathbf{a} - \\mathbf{b}$:'),
