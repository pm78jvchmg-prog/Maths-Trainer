    ...
    },
    {
      ...
      slides: [
        teach(
          ...
          prose('Entry by entry:'),
          stacked('5 - 3 = 2', '2 - \\left(-4\\right) = 6'),
          prose('Bracket a negative being taken away: taking away $-4$ adds 4, and adding instead is the usual slip.'),
    ...
    },
    {
      ...
      slides: [
        ...
        teach(
          ...
          prose('If instead'),
          display('3\\mathbf{x} - \\mathbf{a} = \\mathbf{b}'),
          prose('add $\\mathbf{a}$ to both sides, then divide by 3:'),
          display('3\\mathbf{x} = \\mathbf{b} + \\mathbf{a}'),
        ),
