    ...
    },
    {
      ...
      slides: [
        ...
        teach(
          ...
          prose('Most radii and spins do not come out exactly, so round where the question says. A station of radius $400\\text{ m}$, for ordinary gravity:'),
          stacked('\\omega^{2} = \\frac{9.8}{400} = 0.0245', '\\omega = \\sqrt{0.0245} = 0.15652\\ldots', '\\omega = 0.157\\text{ rad s}^{-1}'),
          prose('That is to 3 significant figures. At $0.3\\text{ rad s}^{-1}$ the radius is $9.8 \\div 0.09 = 108.88\\ldots$, which is $109\\text{ m}$.'),
        ),
        ...
        teach(
          ...
          prose('With $\\mu = 0.5$ and $r = 4\\text{ m}$:'),
          stacked('\\omega^{2} = \\frac{9.8}{0.5 \\times 4} = 4.9', '\\omega = \\sqrt{4.9} = 2.2135\\ldots'),
          prose('To the nearest $0.1\\text{ rad s}^{-1}$, that is $2.2\\text{ rad s}^{-1}$.'),
        ),
        ask('clm-rotor-flow'),
