    ...
    },
    {
      ...
      slides: [
        teach(
          ...
          prose('At any point the kinetic energy is what the spring does not hold: $K = E - \\tfrac{1}{2}kx^{2}$. At $x = 0.1$ the spring holds $1\\text{ J}$, so $K = 8\\text{ J}$.'),
        ),
        ...
        teach(
          ...
          display('\\tfrac{1}{2}mv^{2} = \\tfrac{1}{2}k\\left(A^{2} - x^{2}\\right)'),
          prose('A $2\\text{ kg}$ mass, $k = 50\\text{ N m}^{-1}$, amplitude $0.5\\text{ m}$, at $x = 0.3$:'),
    ...
    },
    {
      ...
      slides: [
        teach(
          ...
          stacked('h = 5 \\times 0.5 = 2.5\\text{ m}', 'v = \\sqrt{19.6 \\times 2.5} = 7\\text{ m s}^{-1}'),
          prose('Where the angle is given by its cosine, use it straight in: $\\cos\\theta = 0.8$ on a $12.5\\text{ m}$ rope drops $12.5 \\times 0.2 = 2.5\\text{ m}$ too.'),
        ),
        ask('clm-swing-speed'),
