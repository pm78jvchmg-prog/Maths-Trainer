    ...
    },
    {
      ...
      slides: [
        ...
        teach(
          ...
          prose('The two circles, then the curved side:'),
          display('2 \\times \\pi \\times 3^2 = 18\\pi'),
          display('2 \\times \\pi \\times 3 \\times 8 = 48\\pi'),
    ...
    },
    {
      ...
      slides: [
        teach(
          ...
          prose('The four triangles:'),
          display('4 \\times \\tfrac{1}{2} \\times 6 \\times 5 = 60'),
          display('A = 36 + 60 = 96'),
