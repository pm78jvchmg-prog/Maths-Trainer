  ...
  lessons: [
    {
      ...
      slides: [
        teach(
          ...
          prose('Thrown at $6\\text{ m s}^{-1}$ from $19.6\\text{ m}$ up:'),
          stacked('t^{2} = 19.6 \\div 4.9 = 4', 't = 2\\text{ s}', 'R = 6 \\times 2 = 12\\text{ m}'),
        ...
        teach(
          prose('As it falls it gains downward speed $v_{y} = gt$, while its sideways speed never changes. From the same $19.6\\text{ m}$, it lands with $v_{y} = 9.8 \\times 2 = 19.6\\text{ m s}^{-1}$.'),
          prose('Backwards, for the launch speed: to land $12\\text{ m}$ out after $2\\text{ s}$ in the air needs $u = 12 \\div 2 = 6\\text{ m s}^{-1}$.'),
        ),
        ask('clm-horiz-tree'),
        ask('clm-horiz-slider', 2),
        teach(
          prose('To see whether it reaches a target, work out where it lands and compare. A ball rolls off a $4.9\\text{ m}$ wall at $5\\text{ m s}^{-1}$:'),
          stacked('t^{2} = 4.9 \\div 4.9 = 1', 't = 1\\text{ s}', 'R = 5 \\times 1 = 5\\text{ m}'),
          prose('So it gets past a mark $4\\text{ m}$ out, by $1\\text{ m}$, but not one $6\\text{ m}$ out.'),
        ),
        ask('clm-horiz-flow'),
    ...
    },
    {
      ...
      slides: [
        ...
        teach(
          ...
          prose('With $u_{x} = 10$ and $u_{y} = 14.7$:'),
          stacked('t_{\\text{top}} = 14.7 \\div 9.8 = 1.5', 'T = 2 \\times 1.5 = 3', 'H = \\frac{14.7^{2}}{19.6} = 11.025', 'R = 10 \\times 3 = 30'),
        ),
        ask('clm-range-flow'),
        ask('clm-flight-tree'),
        ask('clm-max-height'),
        teach(
          prose('Given a speed and an angle, split it first. At $24.5\\text{ m s}^{-1}$ with $\\tan\\alpha = \\tfrac{4}{3}$, the $3, 4, 5$ triangle gives $\\sin\\alpha = \\tfrac{4}{5} = 0.8$ and $\\cos\\alpha = \\tfrac{3}{5} = 0.6$:'),
          stacked('u_{x} = 24.5 \\times 0.6 = 14.7', 'u_{y} = 24.5 \\times 0.8 = 19.6', 'T = \\frac{2 \\times 19.6}{9.8} = 4', 'H = \\frac{19.6^{2}}{19.6} = 19.6', 'R = 14.7 \\times 4 = 58.8'),
        ),
    ...
    },
    {
      ...
      slides: [
        ...
        teach(
          ...
          display('v = r\\omega'),
          prose('A wheel of radius $0.35\\text{ m}$ at $20\\text{ rad s}^{-1}$: $v = 0.35 \\times 20 = 7\\text{ m s}^{-1}$. Backwards, $\\omega = v \\div r$.'),
        ),
        ask('clm-rim-speed'),
    ...
    },
    {
      ...
      slides: [
        ...
        teach(
          ...
          prose('So the turning alone gives $2g$.'),
        ),
