    ...
    },
    {
      ...
      slides: [
        ...
        teach(
          ...
          prose(
            'When $\\alpha$ is not a special angle, $\\tan^{-1}$ on a calculator gives it. $3$ km west and $4$ km south has $\\alpha \\approx 36.9^\\circ$, so its bearing is',
          ),
    ...
    },
    {
      ...
      slides: [
        ...
        teach(
          ...
          prose('It heads back on $135^\\circ$, and the distance back, in km, is'),
          display('\\sqrt{6^2 + 6^2} = 6\\sqrt{2}'),
        ),
        ask('vjour-home'),
