  ...
  lessons: [
    ...
    },
    {
      ...
      slides: [
        ...
        teach(
          prose('For a pendulum, set a length $\\ell$ and $g$ to $1$. The unit of time is $\\tau = \\sqrt{\\ell/g}$ and the unit of speed is $u = \\ell/\\tau$. With a length of $2.5\\text{ m}$ as the unit, rounding each to 3 significant figures:'),
          stacked('\\tau = \\sqrt{\\frac{2.5}{9.8}} = 0.5050\\ldots', '\\tau = 0.505\\text{ s}', 'u = \\frac{2.5}{0.505} = 4.95\\text{ m s}^{-1}'),
