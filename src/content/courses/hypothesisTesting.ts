      ...
      lessons: [
        {
          ...
          slides: [
            teach(
              ...
              prose('From Testing a Mean, a sample mean is normal with variance $\\frac{\\sigma^2}{n}$. The difference of two independent sample means is normal too, with'),
        ...
        },
        {
          ...
          slides: [
            ...
            asking(
              'hyp-diff-z-tiles',
              1,
              prose('With $16$ bags from each machine, $\\sigma_A = 12$ g and $\\sigma_B = 16$ g. The samples give $\\bar{x}_A = 506.1$ g and $\\bar{x}_B = 497.6$ g:'),
              working(
                '\\bar{x}_A - \\bar{x}_B &= 506.1 - 497.6 = 8.5',
                '\\text{sd} &= \\sqrt{\\tfrac{144}{16} + \\tfrac{256}{16}} = 5',
                'z &= 8.5 \\div 5 = 1.7',
              ),
            ),
            ask('hyp-diff-z'),
            ...
            teach(
              ...
              working('\\bar{x}_A - \\bar{x}_B &= 497.6 - 503.1 = -5.5', 'z &= -5.5 \\div 5 = -1.1'),
        ...
        },
        {
          ...
          slides: [
            ...
            teach(
              ...
              working('z &= -11.2 \\div 5 = -2.24', '|z| &= 2.24 > 1.96'),
