# Inequalities & the Modulus Function: level plan

Written by C8.

Has: Inequalities (linear on the number line, and/or and double inequalities,
...
regions bounded by two modulus graphs); Piecewise Functions (defining,
sketching and evaluating piecewise functions, writing |ax + b| piecewise, and
...
`le-l4`, and quadratic inequalities by factorising stay with `qd-l5`.
