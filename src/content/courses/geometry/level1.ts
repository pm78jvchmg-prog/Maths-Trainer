  ...
  lessons: [
    {
      ...
      slides: [
        ...
        teach(
          ...
          prose('Then each angle:'),
          display('2 \\times 36 = 72 \\qquad 3 \\times 36 = 108'),
          prose('They add to $180^\\circ$, which checks the answer.'),
    ...
    },
    {
      ...
      slides: [
        ...
        teach(
          ...
          prose('Backwards: two equal angles of $65^\\circ$ leave $50^\\circ$ at the top:'),
          display('180 - 65 - 65 = 50'),
          prose('With all three sides equal, the triangle is **equilateral** and every angle is $60^\\circ$.'),
        ),
        ask('geo-isosceles'),
