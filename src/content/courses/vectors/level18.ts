  ...
  lessons: [
    {
      ...
      slides: [
        teach(
          ...
          prose('Against $\\Pi_1\\colon x - 2y + 3z = 4$:'),
          display('2x - 4y + 6z = 8'),
        ...
        askAfter(
          [
            prose(
              'For $2x - y + 3z = 1$ and $6x + ky + 9z = 7$ to be parallel, the normals must be multiples. The $x$ terms give the multiple:',
            ),
            stacked('6 \\div 2 = 3', 'k = 3 \\times (-1) = -3'),
            prose(
              'For the same plane the constant takes the multiple too: $3x - y + 2z = 4$ and $6x - 2y + 4z = d$ give $d = 2 \\times 4 = 8$.',
            ),
          ],
          'vplx-planes-unknown',
        ),
        ...
        teach(
          ...
          prose('For $x + 2y + 2z = 3$ and $2x - 3y + 6z = 1$:'),
          stacked(
    ...
    },
    {
      ...
      slides: [
        teach(
          ...
          prose(
            'For $x + 2y - z = 5$ and $2x - y + z = 5$, the normals are $\\left(1, 2, -1\\right)$ and $\\left(2, -1, 1\\right)$:',
          ),
    ...
    },
    {
      ...
      slides: [
        ...
        teach(
          ...
          prose('So the planes meet at $\\left(1, 2, -1\\right)$. Check it in all three: $1 + 2 - 1 = 2$, $1 - 2 - 2 = -3$, $2 + 2 + 1 = 5$.'),
        ),
    ...
    },
    {
      ...
      slides: [
        teach(
          ...
          prose(
            'A letter in a normal can make the determinant zero. With $\\mathbf{n}_1 = \\left(k, 1, -1\\right)$ and $\\mathbf{n}_2 \\times \\mathbf{n}_3 = \\left(-1, 5, 3\\right)$:',
          ),
          stacked('-k + 5(1) + 3(-1) = 0', '2 - k = 0 \\implies k = 2'),
        ),
        ask('vplx-det'),
        ask('vplx-singular-k'),
        ...
        askAfter(
          [
            ...
            prose('With $\\Pi_1\\colon x + 2y - z = 1$ and $\\Pi_2\\colon 2x - y + z = 3$ above:'),
