...

        {
          ...
          slides: [
            teach(
              ...
              { kind: 'prose', text: 'A square equal to $-4$ has no real solution — but now that $i$ is here, it does have an imaginary one.' },
            ...
            teach(
              ...
              { kind: 'prose', text: 'So every quadratic with real coefficients has either two real roots, one repeated real root, or a conjugate pair — the discriminant says which. Complex Arithmetic, Conjugates, makes more of that conjugate.' },
            ),
            ask('root-pair', 2),
            showing(
...

        {
          ...
          slides: [
            ...
            teach(
              ...
              { kind: 'prose', text: 'Moduli also multiply: $|zw| = |z||w|$. Distances scale under multiplication, which is the other half of the "scale and rotate" picture from Complex Arithmetic, Multiplication.' },
...

        {
          ...
          slides: [
            ...
            teach(
              ...
              { kind: 'prose', text: 'Multiplying by $i$ (modulus $1$, argument $\\tfrac{\\pi}{2}$) is the quarter turn from Complex Arithmetic, Multiplication, now as a formula.' },
...

        {
          ...
          slides: [
            ...
            teach(
              ...
              { kind: 'display', tex: 'i^2 = -1 \\qquad i^3 = -i \\qquad i^4 = 1' },
              { kind: 'prose', text: 'That is the four-step cycle of powers of $i$ from Complex Arithmetic, Multiplication, now with a reason attached: $i$ has argument $\\frac{\\pi}{2}$, so four steps make a full turn and land back at the start. The pattern was never a coincidence.' },
...

        {
          ...
          slides: [
            ...
            teach(
              ...
              { kind: 'prose', text: 'The four-step cycle of powers of $i$ ($i$, $-1$, $-i$, $1$) is De Moivre with $r = 1$ and $\\theta = \\tfrac{\\pi}{2}$.' },
            ),
            ask('polar-multiply', 2),
            ask('complex-power+choice', 2),
          ],
