        ...
        },
        {
          ...
          slides: [
            teach(
              ...
              prose('Thrown up at $20$ m/s, after 1 s: $s = 20 - 4.9 = 15.1$ m and $v = 20 - 9.8 = 10.2$ m/s.'),
            ),
            ask('kin-grav-height'),
            ask('kin-grav-steps'),
            askAfter(
              [
                prose('Back at the level it was thrown from, $s = 0$. Thrown up at $12$ m/s, take out the common factor $t$:'),
                working('12t - 4.9t^{2} &= 0', 't(12 - 4.9t) &= 0', 't = 0 \\text{ or } t &= 12 \\div 4.9 = 2.448\\ldots'),
                prose('$t = 0$ is the throw, so it is back at $t = 2.4$ s to the nearest 0.1 s.'),
              ],
              'kin-grav-slider',
            ),
            teach(
              prose('At the **greatest height** it stops for an instant: $v = 0$. So the time to the top is $t = \\frac{u}{9.8}$, and the height gained is $\\tfrac{1}{2}(u + 0)t$. Thrown up at $15$ m/s from 10 m above the ground, with times to 2 decimal places and heights to 1:'),
              working('0 &= 15 - 9.8t', 't &= 15 \\div 9.8 = 1.5306\\ldots = 1.53', 's &= \\tfrac{1}{2}(15 + 0) \\times 1.53', '&= 11.475 = 11.5', '\\text{height} &= 10 + 11.5 = 21.5'),
              prose('Carrying the unrounded time gives $11.479\\ldots$, the same $11.5$: round at the end of each line, not before.'),
            ...
            teach(
              prose('From the top it falls from rest, so it falls $4.9t^{2}$. Thrown up at $15$ m/s from 25 m above the ground:'),
              working(
                '\\text{top at: } t &= 1.53',
                '\\text{rising: } s &= 11.5',
                '\\text{top: } 25 + 11.5 &= 36.5',
                '\\text{fall: } 4.9t^{2} &= 36.5',
                't &= \\sqrt{36.5 \\div 4.9} = 2.729\\ldots = 2.73',
                '\\text{in the air: } 1.53 + 2.73 &= 4.26',
              ),
              prose('Solving $-25 = 15t - 4.9t^{2}$ in one go (Quadratics, "The Quadratic Formula") gives $4.259\\ldots$, the same 4.26 s to 2 decimal places; keep the positive root.'),
            ),
